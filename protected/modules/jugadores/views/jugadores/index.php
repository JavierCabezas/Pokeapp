...
<nav>
	<ul>
		<li><?php echo CHtml::link('<img src="'.Yii::app()->request->baseUrl.'/images/pj_nav/n_pj_01.png" width="180" height="100" />',  Yii::app()->createurl('jugadores/create')) //Module/controller/view ?> </li>
		<li><?php echo CHtml::link('<img src="'.Yii::app()->request->baseUrl.'/images/pj_nav/n_pj_02.png" width="180" height="100" />',  Yii::app()->createurl('jugadores/buscador')) //Module/controller/view ?> </li>

		<li><?php echo CHtml::link('<img src="'.Yii::app()->request->baseUrl.'/images/pj_nav/n_pj_03.png" width="180" height="100" />',  Yii::app()->createurl('jugadores/nuevoCodigo')) //Module/controller/view ?> </li>
		<li><?php echo CHtml::link('<img src="'.Yii::app()->request->baseUrl.'/images/pj_nav/n_pj_04.png" width="180" height="100" />',  Yii::app()->createurl('jugadores/updateForm')) //Module/controller/view ?> </li>
	</ul>
</nav>
