	...
	<div class='search_results'>
		...
		<div class='type_results'>
			<div id='div_type_1_result'>
				...
				<div class='type_remove' id='type_remove_1'>  <img src='<?php echo imageDir()?>/buscador/remove.png' alt='sacar' /></div>
			</div>
			<div id='div_type_2_result'>
				<p> Tipo 2: <span class='type' id='type_2_result'> </span> </p>
				<div class='type_remove' id='type_remove_2'>  <img src='<?php echo imageDir()?>/buscador/remove.png' alt='sacar' /></div>
			</div>
		</div> <!-- end of type results -->

		<div class='inmunity_results'>
			<div id='div_inmunity_result'>
				<p> Inmune a <span class='type' id='inmunity_result'> </span> </p>
				<div class='inmunity_remove' id='inmunity_remove_'>  <img src='<?php echo imageDir()?>/buscador/remove.png' alt='sacar' /></div>
			</div>
