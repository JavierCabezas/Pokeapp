...
/**
 * This is the model class for table "ability_names".
 *
 * The followings are the available columns in table 'ability_names':
 * @property integer $id
 ...
 */
class AbilityNames extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('ability_id, local_language_id, name', 'required'),
			array('ability_id, local_language_id', 'numerical', 'integerOnly'=>true),
			array('name', 'length', 'max'=>30),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, ability_id, local_language_id, name', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return AbilityNames the static model class
	 */
